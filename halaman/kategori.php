<?php 
	$kat= mysqli_query($koneksi,"SELECT * FROM tbl_kategori Where id_kategori='$_GET[idkate]'");
	$kate=mysqli_fetch_array($kat);
?>
	  	...
	  	<div class="container">
		   	...
		   	<div class="col-md-9 content_right">
		    	...
		    	<div class="top_grid2">
		    		<?php 
		            	$no=1;
		            	$query= mysqli_query($koneksi,"SELECT * FROM tbl_barang a LEFT JOIN tbl_kategori b ON a.id_kategori=b.id_kategori Where a.id_kategori='$_GET[idkate]' Order by id_barang DESC");
