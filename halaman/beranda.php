<div class="slider">
	  <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li><img src="assets/images/s1.png" class="img-responsive" alt=""/>
	        <div class="banner_desc">
				<h1>Kami menyediakan berbagai macam pakaian pria berkualitas</h1>
				
			</div>
	        </li>
	        <li><img src="assets/images/s2.png" class="img-responsive" alt=""/>
	         <div class="banner_desc">
				<h1>Kami memberikan harga murah</h1>
